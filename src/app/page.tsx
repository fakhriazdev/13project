    ...
    <>
      <main className="w-full bg-gray bg-grid-black/[0.2] h-screen flex flex-col items-center justify-start text-black">
        ...
        <div className="max-w-7xl md:flex md:flex-row-reverse justify-center items-center my-auto z-20 mx-auto">
          ...
          <div>
            <h1 className="text-3xl md:text-6xl w-72 md:w-[460px] mb-3 font-medium">
              Make Your Own Application
            </h1>
            <p className="w-80 md:w-[440px] text-sm md:text-md mb-4">
      ...
      <section id="pricing" className="w-full h-[2000px] bg-black">
        <Pricing />
      </section>
