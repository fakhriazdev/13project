...
export default function Home() {
  return (
      <>
          <main
              ...
              <div className="max-w-7xl md:flex md:flex-row-reverse justify-center items-center my-10 z-20 mx-auto">
                  ...
                  <div>
                      ...
                      <div className="max-w-full flex gap-4 justify-center md:justify-start items-center mx-auto">
                          <button
                              className="bg-black text-orange px-8 py-2 rounded-full font-medium text-sm md:text-md">
                              Portfolio
                          </button>
                          <button
                              className="bg-orange text-black px-8 py-2 rounded-full font-medium text-sm md:text-md">
                              Contact Us
                          </button>
                      </div>
                  </div>
          ...
          <section id="service" className="w-full h-screen bg-gray">
              <Service/>
          </section>
          <section id="pricing" className="w-full h-auto bg-neutral-200">
              <Pricing/>
          </section>
